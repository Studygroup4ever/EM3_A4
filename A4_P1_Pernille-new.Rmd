...
# Shuffled pairs:  INSERT CODE
When creating shuffled controls, we break the temporal dependencies.
...
# (df for checking if we did it right)
compare_df <- df %>% 
  filter(Group != 408,
...
# MANGLER SHUFFLE CODE + MODEL KODE
