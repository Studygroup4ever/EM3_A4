...
df <- df %>% 
  mutate(prev_HR1 = lag(HR1_c_scaled),
         ...
         change_HR1 = HR1_c_scaled-prev_HR1,
...
long <- long %>%
  mutate(
    ...
    HR_self_lag = tidyr::pivot_longer(df, c(prev_HR1, prev_HR2))[['value']],
    HR_other_lag = tidyr::pivot_longer(df, c(prev_HR2, prev_HR1))[['value']],
    ...
    Resp_self_lag = tidyr::pivot_longer(df, c(prev_Resp1, prev_Resp2))[['value']],
    Resp_other_lag = tidyr::pivot_longer(df, c(prev_Resp2, prev_Resp1))[['value']],
